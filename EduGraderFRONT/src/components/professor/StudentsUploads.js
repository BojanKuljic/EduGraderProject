                                    ...
                                    <div className="grade-actions">
                                        {editMode === upload.id ? (
                                            <>
                                                ...
                                                />
                                                <button
                                                    className="details-button button-edit"
                                                    onClick={() => handleSaveEditedGrade(upload.id)}
                                                >
                                                    Save
                                                </button>
                                            </>
                                            ...
                                            <>
                                                <button
                                                    className="details-button button-accept"
                                                    onClick={() => handleConfirmGrade(upload.id, upload.review?.grade)}
                                                >
                                                    Accept
                                                </button>
                                                <button
                                                    className="details-button button-edit"
                                                    onClick={() => {
                                                        setEditMode(upload.id);
                                                        setNewGrade(upload.review?.grade ?? "");
                                                    }}
